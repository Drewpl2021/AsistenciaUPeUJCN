...
import pe.edu.upeu.asistenciaupeujcn.modelo.ComboModel
...
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.AccionButtonCancel
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.AccionButtonSuccess
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.ComboBox
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.ComboBoxTwo
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.DatePickerCustom
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.DropdownMenuCustom
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.MyFormKeys
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.NameTextField
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.components.form.TimePickerCustom
    ...
    32.dp)){
        BuildEasyForms { easyForm ->
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                NameTextField(easyForms = easyForm, text
                =actividad?.nombreActividad!!,"Nomb. Actividad:", MyFormKeys.NAME )
                var listE = listOf(
